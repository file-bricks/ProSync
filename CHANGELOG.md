...
- Reproduzierbares Windows-Build-Skript `build_exe.bat` fuer ProSync und ProSyncReader
...
- Frozen-Builds verwenden das EXE-Verzeichnis fuer Icons, Konfiguration und Reader-Start
